...
namespace UdonSharp.Video.Internal
{
    ...
    internal class USharpVideoInspector : Editor
    {
        ...
        SerializedProperty mediaLibraryLabel;


        private void OnEnable()
        {
            mediaLibrary = serializedObject.FindProperty(nameof(USharpVideoPlayer.mediaLibrary));
            mediaLibraryLabel = serializedObject.FindProperty(nameof(USharpVideoPlayer.mediaLibraryLabels));
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(mediaLibraryLabel);
